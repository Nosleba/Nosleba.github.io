...
const exams = [
  ...
  { num: 3,  title: "Exam — Daily Routines & Time",     tag: "Temas 7–9 · Present Simple",     available: true },
  { num: 4,  title: "Exam — Food & Feelings",           tag: "Temas 10–12 · Likes & Dislikes", available: true },
  { num: 5,  title: "Exam — Body & Health",             tag: "Temas 13–15 · Health Vocab",     available: true },
  { num: 6,  title: "Exam — Animals & Nature",          tag: "Temas 16–18 · Can / Can't",      available: true },
...
// =============================================
const reviews = [
  { num: 1,  title: "Review — Who Am I?",         tag: "Mes 1 · Saludos, Familia, Rutinas", available: true  },
  { num: 2,  title: "Review — My World",           tag: "Mes 2 · Comida, Cuerpo, Animales", available: false },
  { num: 3,  title: "Review — My Community",       tag: "Mes 3 · Lugares, Escuela, Pasado", available: false },
  { num: 4,  title: "Review — I Can Communicate",  tag: "Mes 4 · Compras, Clima, Futuro",  available: false },
];
...
function renderReviews() {
  ...
  reviews.forEach(review => {
    ...
    card.dataset.available = review.available;

    if (review.available) {
      card.href   = `https://nosleba.github.io/Review-${review.num}/`;
      card.target = '_blank';
      card.rel    = 'noopener noreferrer';
    } else {
      card.href = '#';
    ...
    card.innerHTML = `
      ...
      <span class="review-number">Review ${review.num}</span>
